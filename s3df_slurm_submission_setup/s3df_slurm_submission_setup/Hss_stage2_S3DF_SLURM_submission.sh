...
#SBATCH --job-name=Hss_stage2_sample_generation
#SBATCH --output=Hss_stage2_%A_%a.out
#SBATCH --error=Hss_stage2_%A_%a.err
...
#export ALRB_CONT_RUNPAYLOAD="/fs/ddn/sdf/group/atlas/d/dntounis/Hss_setup_test/FCCAnalyses_Winter2023/s3df_slurm_submission_setup/myJobPayload_stage2.sh $FLAVOR $NUMBER "
export ALRB_CONT_RUNPAYLOAD="/fs/ddn/sdf/group/atlas/d/dntounis/Hss_setup_test/FCCAnalyses_Winter2023/s3df_slurm_submission_setup/myJobPayload_stage2_production.sh $FLAVOR $NUMBER $DETECTOR "
