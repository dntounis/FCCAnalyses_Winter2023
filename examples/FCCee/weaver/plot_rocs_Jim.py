...
def main():
    ...
    proc_sid_test_Jim = Process(
        ...
        "outputs_inference_PNet_Hss_SiD_o2_vo4_Winter2023_C_27epochs",
    )
    ...
    plot_param = PlotParams(
        [Text("C3 Simulation (SiD Delphes)", (0.75, 1.03), "bold", 13)],
        ((0.3, 1.0), (0.001, 1.0)),
...
def roc_plot(cfg):
    ...
    plot = Graph(rocs, cfg["param_plot"], "plots_roc/{}.pdf".format(plot_name))
